  ...
  <div class="container">
    ...
    <div class="form-group">
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-11">
                                <input id="fname" name="name" type="text" placeholder="Descripcion" class="form-control"   v-model="form.descripcion" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-11">
                                <input id="fname" name="name" type="datetime-local" placeholder="Descripcion" class="form-control"   v-model="form.fecha_y_Hora" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-11">
                                <input id="fname" name="name" type="text" placeholder="Lugar" class="form-control" v-model="form.lugar" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-11">
                                <input id="fname" name="name" type="text" placeholder="Estado" class="form-control" v-model="form.estado" />
                            </div>
                        </div>
    ...
    <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-11">
                                <input id="fname" name="name" type="text" placeholder="url" class="form-control" v-model="form.urlExterna" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-11">
                                <input id="fname" name="name" type="date" placeholder="Responsable" class="form-control" v-model="form.fecha_caducidad" />
                            </div>
                        </div>
